...
$(document).ready((function(){$(".burger").click((function(e){$(".burger__float, .burger").toggleClass("active"),$("body").toggleClass("overflow-hidden")})),$("[data-modalbtn]").on("click",(function(){let e=document.querySelectorAll(".menu-modal"),a=$(this).data().modalbtn;for(let o=0;o<e.length;o++)e[o].dataset.id===a&&e[o].classList.add("menu-modal_active")})),$(".menu-modal").on("click",(function(e){"menu-modal"===e.target.classList[0]&&$(".menu-modal").removeClass("menu-modal_active")})),$(window).on("keydown",(function({originalEvent:{code:e}}){"Escape"===e&&$(".menu-modal").removeClass("menu-modal_active")})),$(".gallery__album").slick({fade:!0,arrows:!1,dots:!1}),$(".menu__slick").slick({fade:!0,arrows:!1,dots:!1,infinite:!0,autoplay:!0}),$(".show__slick").slick({fade:!0,arrows:!1,dots:!1})}));